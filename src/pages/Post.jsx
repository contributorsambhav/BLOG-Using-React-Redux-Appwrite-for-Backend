...
export default function Post() {
    ...
    return post ? (
        <div className="w-[70%] mx-auto my-4 p-16 rounded-3xl bg-slate-300 text-gray-900 dark:text-gray-200 dark:bg-slate-900">
            <Container>
                ...
                <div className="w-full mt-20 mb-6">
                    <h1 className="text-center text-4xl mt-4 font-bold text-gray-900 dark:text-gray-200">{post.title}</h1>
                </div>
