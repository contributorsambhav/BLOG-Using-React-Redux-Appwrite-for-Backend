            ...
            <div className="w-full py-8 h-[62.3vh] align-middle bg-gray-200 dark:bg-gray-700 text-center">
                <Container>
                    <div className="w-[87%] mx-auto text-center mb-12">
                        <h2 className="sm:text-3xl md:text-4xl lg:text-5xl leading-7 font-semibold text-gray-900 dark:text-white  ">
                            Welcome to DocuSharp
                        </h2><br></br>
                        <p className="w-[87%] leading-relaxed mx-auto mt-3 sm:text-xl selection:md:text-2xl lg:text-3xl text-gray-600 dark:text-gray-300 typing-effect">
                            {displayedIntroText}
                        </p>
                    </div>
                </Container>
        ...
        return (
            <div className="w-full py-8 bg-gray-100 dark:bg-gray-800">
                <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <Container>
                        <div className="p-3 text-slate-800 dark:text-white font-semibold text-xl sm:text-2xl md:text-3xl lg:text-4xl m-8 text-center">
